...
public record PanelState(String title, int x, int y, boolean collapsed, int screenWidth, int screenHeight) {
    public static final Codec<PanelState> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    Codec.INT.fieldOf("screenWidth").forGetter(PanelState::screenWidth),
                    Codec.INT.fieldOf("screenHeight").forGetter(PanelState::screenHeight)
